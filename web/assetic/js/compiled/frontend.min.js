...
(function(d){var c=function(b){var h=b.clone();var g=b.find("canvas");if(g.length){var a=h.find("canvas");a.each(function(f){var e=this.getContext("2d");e.drawImage(g.get(f),0,0)})}return h};d.fn.quicksand=function(a,j){var h={duration:750,easing:"swing",attribute:"data-id",adjustHeight:"auto",adjustWidth:"auto",useScaling:false,enhancement:function(e){},selector:"> *",atomic:false,dx:0,dy:0,maxWidth:0,retainExisting:true},b=(function(){var e="transform WebkitTransform MozTransform OTransform msTransform".split(" "),f=document.createElement("div");for(var g=0;g<e.length;g++){if(typeof f.style[e[g]]!="undefined"){return true}}return false})();d.extend(h,j);if(!b||(typeof(d.fn.scale)=="undefined")){h.useScaling=false}var i;if(typeof(arguments[1])=="function"){i=arguments[1]}else{if(typeof(arguments[2]=="function")){i=arguments[2]}}return this.each(function(U){var I;var P=[];var Y;if(typeof(h.attribute)=="function"){Y=d(a)}else{Y=c(d(a).filter("["+h.attribute+"]"))}var N=d(this);var Z=d(this).css("height");var J=d(this).css("width");var O,T;var X=false;var L=false;var W=d(N).offset();var V=[];var Q=d(this).find(h.selector);var e=d(Q).innerWidth();if(navigator.userAgent.match(/msie [6]/i)){N.html("").append(Y);return}var R=0;var H=function(){d(this).css("margin","").css("position","").css("top","").css("left","").css("opacity","");if(!R){R=1;if(!h.atomic){var l=N.find(h.selector);if(!h.retainExisting){N.prepend(g.find(h.selector));l.remove()}else{var k=d([]);g.find(h.selector).each(function(o){var n=d([]);if(typeof(h.attribute)=="function"){var m=h.attribute(d(this));l.each(function(){if(h.attribute(this)==m){n=d(this);return false}})}else{n=l.filter("["+h.attribute+'="'+d(this).attr(h.attribute)+'"]')}if(n.length>0){k=k.add(n);if(o===0){N.prepend(n)}else{n.insertAfter(N.find(h.selector).get(o-1))}}});l.not(k).remove()}if(X){N.css("height",O)}if(L){N.css("width",J)}}h.enhancement(N);if(typeof i=="function"){i.call(this)}}if(false===h.adjustHeight){N.css("height","auto")}if(false===h.adjustWidth){N.css("width","auto")}};var S=N.offsetParent();var f=S.offset();if(S.css("position")=="relative"){if(S.get(0).nodeName.toLowerCase()!="body"){f.top+=(parseFloat(S.css("border-top-width"))||0);f.left+=(parseFloat(S.css("border-left-width"))||0)}}else{f.top-=(parseFloat(S.css("border-top-width"))||0);f.left-=(parseFloat(S.css("border-left-width"))||0);f.top-=(parseFloat(S.css("margin-top"))||0);f.left-=(parseFloat(S.css("margin-left"))||0)}if(isNaN(f.left)){f.left=0}if(isNaN(f.top)){f.top=0}f.left-=h.dx;f.top-=h.dy;N.css("height",d(this).height());N.css("width",d(this).width());Q.each(function(k){V[k]=d(this).offset()});d(this).stop();var K=0;var M=0;Q.each(function(l){d(this).stop();var k=d(this).get(0);if(k.style.position=="absolute"){K=-h.dx;M=-h.dy}else{K=h.dx;M=h.dy}k.style.position="absolute";k.style.margin="0";if(!h.adjustWidth){k.style.width=(e+"px")}k.style.top=(V[l].top-parseFloat(k.style.marginTop)-f.top+M)+"px";k.style.left=(V[l].left-parseFloat(k.style.marginLeft)-f.left+K)+"px";if(h.maxWidth>0&&V[l].left>h.maxWidth){k.style.display="none"}});var g=c(d(N));var ab=g.get(0);ab.innerHTML="";ab.setAttribute("id","");ab.style.height="auto";ab.style.width=N.width()+"px";g.append(Y);g.insertBefore(N);g.css("opacity",0);ab.style.zIndex=-1;ab.style.margin="0";ab.style.position="absolute";ab.style.top=W.top-f.top+"px";ab.style.left=W.left-f.left+"px";if(h.adjustHeight==="dynamic"){N.animate({height:g.height()},h.duration,h.easing)}else{if(h.adjustHeight==="auto"){O=g.height();if(parseFloat(Z)<parseFloat(O)){N.css("height",O)}else{X=true}}}if(h.adjustWidth==="dynamic"){N.animate({width:g.width()},h.duration,h.easing)}else{if(h.adjustWidth==="auto"){T=g.width();if(parseFloat(J)<parseFloat(T)){N.css("width",T)}else{L=true}}}Q.each(function(l){var k=[];if(typeof(h.attribute)=="function"){I=h.attribute(d(this));Y.each(function(){if(h.attribute(this)==I){k=d(this);return false}})}else{k=Y.filter("["+h.attribute+'="'+d(this).attr(h.attribute)+'"]')}if(k.length){if(!h.useScaling){P.push({element:d(this),dest:k,style:{top:d(this).offset().top,left:d(this).offset().left,opacity:""},animation:{top:k.offset().top-f.top,left:k.offset().left-f.left,opacity:1}})}else{P.push({element:d(this),dest:k,style:{top:d(this).offset().top,left:d(this).offset().left,opacity:""},animation:{top:k.offset().top-f.top,left:k.offset().left-f.left,opacity:1,scale:"1.0"}})}}else{if(!h.useScaling){P.push({element:d(this),style:{top:d(this).offset().top,left:d(this).offset().left,opacity:""},animation:{opacity:"0.0"}})}else{P.push({element:d(this),animation:{opacity:"0.0",style:{top:d(this).offset().top,left:d(this).offset().left,opacity:""},scale:"0.0"}})}}});Y.each(function(m){var n=[];var k=[];if(typeof(h.attribute)=="function"){I=h.attribute(d(this));Q.each(function(){if(h.attribute(this)==I){n=d(this);return false}});Y.each(function(){if(h.attribute(this)==I){k=d(this);return false}})}else{n=Q.filter("["+h.attribute+'="'+d(this).attr(h.attribute)+'"]');k=Y.filter("["+h.attribute+'="'+d(this).attr(h.attribute)+'"]')}var l;if(n.length===0&&k.length>0){if(!h.useScaling){l={opacity:"1.0"}}else{l={opacity:"1.0",scale:"1.0"}}var p=c(k);var o=p.get(0);o.style.position="absolute";o.style.margin="0";if(!h.adjustWidth){o.style.width=e+"px"}o.style.top=k.offset().top-f.top+"px";o.style.left=k.offset().left-f.left+"px";p.css("opacity",0);if(h.useScaling){p.scale(0)}p.appendTo(N);if(h.maxWidth===0||k.offset().left<h.maxWidth){P.push({element:d(p),dest:k,animation:l})}}});g.remove();if(!h.atomic){h.enhancement(N);for(U=0;U<P.length;U++){P[U].element.animate(P[U].animation,h.duration,h.easing,H)}}else{$toDelete=N.find(h.selector);N.prepend(g.find(h.selector));for(U=0;U<P.length;U++){if(P[U].dest&&P[U].style){var ac=P[U].dest;var aa=ac.offset();ac.css({position:"relative",top:(P[U].style.top-aa.top),left:(P[U].style.left-aa.left)});ac.animate({top:"0",left:"0"},h.duration,h.easing,H)}else{P[U].element.animate(P[U].animation,h.duration,h.easing,H)}}$toDelete.remove()}})}})(jQuery);
(function(h){function g(b){var a=b.data("_ARS_data");if(!a){a={rotateUnits:"deg",scale:1,rotate:0};b.data("_ARS_data",a)}return a}function i(b,a){b.css("transform","rotate("+a.rotate+a.rotateUnits+") scale("+a.scale+","+a.scale+")")}h.fn.rotate=function(a){var b=h(this),d,c=g(b);if(typeof a=="undefined"){return c.rotate+c.rotateUnits}d=a.toString().match(/^(-?\d+(\.\d+)?)(.+)?$/);if(d){if(d[3]){c.rotateUnits=d[3]}c.rotate=d[1];i(b,c)}return this};h.fn.scale=function(a){var b=h(this),c=g(b);if(typeof a=="undefined"){return c.scale}c.scale=a;i(b,c);return this};var j=h.fx.prototype.cur;h.fx.prototype.cur=function(){if(this.prop=="rotate"){return parseFloat(h(this.elem).rotate())}else{if(this.prop=="scale"){return parseFloat(h(this.elem).scale())}}return j.apply(this,arguments)};h.fx.step.rotate=function(b){var a=g(h(b.elem));h(b.elem).rotate(b.now+a.rotateUnits)};h.fx.step.scale=function(a){h(a.elem).scale(a.now)};var f=h.fn.animate;h.fn.animate=function(a){if(typeof a.rotate!="undefined"){var b,c,d=a.rotate.toString().match(/^(([+-]=)?(-?\d+(\.\d+)?))(.+)?$/);if(d&&d[5]){b=h(this);c=g(b);c.rotateUnits=d[5]}a.rotate=d[1]}return f.apply(this,arguments)}})(jQuery);
...
$(function(){$("header nav.main .submenu > ul > li > a").hover(function(){$("header nav.main .submenu li").removeClass("active");if($(this).next().hasClass("submenu2")){$(this).parent().addClass("active")}});$("body").on("click",".readmore",function(){if($(this).parent().find(".moreinfo").length){$(this).parent().find(".moreinfo").toggle(200)}else{$(this).parent().parent().find(".moreinfo").toggle(200)}$(this).find("span").toggle(200)});$("section.catalog article .panel .view span").click(function(){$(this).addClass("active").siblings().removeClass("active");$("#productlist").removeClass().addClass($(this).attr("rel"))});if($("section.catalog article .panel .sort select, select.css, section.register select").length){$("section.catalog article .panel .sort select, select.css, section.register select").each(function(){var b='<div class="input select">';b+="<span>"+$(this).find('option[value="'+$(this).val()+'"]').html()+"</span><ul>";$(this).find("option").each(function(){b+='<li data-value="'+$(this).val()+'" '+($(this).prop("selected")?'class="selected"':"")+">"+$(this).html()+"</li>"});b+="</ul></div>";$(this).hide().after(b)});$("div.input.select > span").click(function(){$(this).parent().find("ul").toggle(200)});$("div.input.select li").click(function(){$(this).addClass("selected").siblings().removeClass("selected");$(this).parents("div.select").prev().val($(this).data("value")).trigger("change");$(this).parents("div.input.select").find("span").html($(this).html());$(this).parent().toggle(200)})}$("section.catalog aside .line_range").each(function(){var c=this;var b=$(c).closest("div.filter");noUiSlider.create(c,{start:[$(c).data("current-min"),$(c).data("current-max")],step:$(c).data("step")||1,connect:true,range:{min:$(c).data("min"),max:$(c).data("max")}});if($(c).data("current-min")==$(c).data("current-max")){$(c).attr("disabled"," disabled")}c.noUiSlider.on("change",function(d,e){if(e){$("input.range.max",b).trigger("change")}else{$("input.range.min",b).trigger("change")}});c.noUiSlider.on("update",function(d,e){if(e){$("input.range.max",b).val(isNaN(parseFloat(d[e]))?"":parseFloat(d[e]))}else{$("input.range.min",b).val(isNaN(parseFloat(d[e]))?"":parseFloat(d[e]))}});$("input.range",b).change(function(){c.noUiSlider.set([$(this).parent().find("input.min").val(),$(this).parent().find("input.max").val()])})});if($('input[type="checkbox"], input[type="radio"]').length){$('input[type="checkbox"], input[type="radio"]').not(".hidden").each(function(){$(this).hide().after('<span class="input checkbox '+($(this).prop("checked")?"checked":"")+'" rel="'+$(this).attr("type")+$(this).attr("name")+'"></span>')})}$("body").on("change",'input[type="checkbox"], input[type="radio"]',function(){if($(this).attr("type")=="radio"){$(this).parents("form").find('span.input.checkbox[rel="'+$(this).attr("type")+$(this).attr("name")+'"]').removeClass("checked")}if($(this).is(":checked")){$(this).next().addClass("checked")}else{$(this).next().removeClass("checked")}});$("body").on("click","span.input.checkbox",function(b){if(!$(this).parents("label").length){$(this).prev().trigger("click")}});$("section.catalog aside .filter .name").not('[data-one="1"]').click(function(){$(this).parents(".filter").find(".block").toggle(200);$(this).parents(".filter").toggleClass("active")});var a;$("header .dop-menu input[name='q']").on("input",function(b){if(!a){a=1;setTimeout(function(){var c=$("header .dop-menu input[name='q']");var d=c.val();if(d.length>2){$("#search_results").show();c.parents("form").addClass("active");$.ajax({url:"/app_dev.php/api/frontend/search/",global:false,data:{query:d},success:function(h){console.log(h);$("#search_results .wrap").html("");if(h.count==0){$("#search_results .wrap").html("<p>Сожалеем, но ничего не найдено.</p>")}else{var g=5;if(h.content.length<5){g=h.content.length}for(var f=0;f<=g-1;f++){var e='<li><a target="_blank" href="/catalog/'+h.content[f].id+"/"+h.content[f].alias+'"><span class="img"><img src="//'+h.content[f].image_path+'" alt=""></span>'+h.content[f].title+"</a></li>";$("#search_results .wrap").append(e)}$("#search_results .wrap").append('<li class="view_all"><a href="/products/search?query='+h.query+'">Остальные результаты</a></li>')}}})}else{$("#search_results").hide();c.parents("form").removeClass("active")}a=0},1000)}});$("#search_results .close").on("click",function(){$("#search_results").hide();$(this).parents("form").removeClass("active")});if($.isFunction($.fancybox)){$(".fancybox").fancybox()}$("body").on("click","#product_delivery .delivery li .title .map, .pvz_block .map",function(){$(".deliveryMaps table td."+$(this).attr("rel")).trigger("click")});$("body").on("click",".pvz_block .map",function(){popup_window('<div id="pvzmap"></div>',$(this).data("address").split("||").join(". "));pvz_map("pvzmap",$(this).data("address").split("||"))});$(window).scroll(function(){if($("body").hasClass("mobile")){return}$("section.user-panel,section.scroll-top")["fade"+($(this).scrollTop()>400?"In":"Out")](500);if($(".main-slider").length){$("a.sale_bnr")["fade"+($(this).scrollTop()>800?"In":"Out")](500)}else{if(!$(".sale_banner").length){$("a.sale_bnr")["fade"+($(this).scrollTop()>400?"In":"Out")](500)}}if($("#product_menu").length){$("#product_menu")[($(this).scrollTop()>=(!$("#product_menu").hasClass("fixed")?$("#product_menu").offset().top:$("#product_menu + section").offset().top)?"add":"remove")+"Class"]("fixed")}});$("section.scroll-top ul li .scrolltotop").click(function(){$("body,html").animate({scrollTop:0},800);return false});$(".help-info").click(function(){$(this).toggleClass("active")});if($(".popup_youtube").length){$("body").on("click",".popup_youtube",function(){$(this).attr("href",$(this).attr("rel"))});$(".popup_youtube").fancybox({width:"75%",height:"75%",autoScale:false,transitionIn:"none",transitionOut:"none",type:"iframe"})}if($("img.lazy").length){$("img.lazy").lazyload()}$("header nav.main > ul > li").hover(function(){$(this).find("img.lazy").each(function(){$(this).attr("src",$(this).data("original"))})});$("section.product-list ul").each(function(){if(!$(this).parents(".wrap-mobile-slider, .slick-slider").length){$(this).wrap('<div class="wrap-mobile-slider">')}});if($("section.product-list .wrap-mobile-slider ul").length){$("section.product-list .wrap-mobile-slider ul").addClass("mobile-slick").slick({infinite:true,speed:700,slidesToShow:2,variableWidth:true})}if($.isFunction($().slick)){$(".slider ul.s.auto").slick({lazyLoad:"ondemand",dots:true,speed:700,autoplay:true,autoplaySpeed:5000,pauseOnHover:false});$(".slider ul.s").slick({lazyLoad:"ondemand",dots:true,speed:700});$(".slider ul.multi").slick({lazyLoad:"ondemand",infinite:true,speed:700,slidesToShow:8,variableWidth:true});$(".slider ul.multi4").slick({lazyLoad:"ondemand",infinite:true,speed:700,slidesToShow:4,variableWidth:true});if($("section.bnrs + section.products-hit, section.slider + section.novelty").length){$("section.bnrs + section.products-hit ul, section.slider + section.novelty ul").addClass("mobile-slick").slick({infinite:true,speed:700,slidesToShow:2,variableWidth:true})}}if($(".quicksand-contents li").length){$(".quicksand-contents li").each(function(b){$(this).attr("data-id","tab"+b)});$(".quicksand-tabs li:first-child").addClass("active");$(".quicksand-contents .block.show").each(function(b){$(this).clone().removeClass("show").insertAfter($(this))});$(".quicksand-tabs li").on("click",function(c){if($(this).hasClass("active")){return false}var b=$(this);b.addClass("active").siblings().removeClass("active");b.parents(".quicksand-wrapper").find(".quicksand-contents .block.show ul").quicksand(b.parents(".quicksand-wrapper").find(".quicksand-contents li.tag-"+b.data("tag")),{duration:1000,useScaling:true,adjustHeight:false});c.preventDefault()})}$('input[name="accept_rules"]').click(function(){if($('input[name="accept_rules"]').is(":checked")){if(!$('input[name="register_submit_button"]').is(":visible")){$(".confirm").removeClass("error");$('input[name="register_submit_button"]').show()}}else{if($('input[name="register_submit_button"]').is(":visible")){$('input[name="register_submit_button"]').hide()}}});$("#fos_user_registration_form_phone").mask("+7 (999) 999-9999");$('form[name="fos_user_registration_form"]').submit(function(){if(!$('input[name="accept_rules"]').is(":checked")){$(".confirm").addClass("error");return false}})});