<?php
//src/PiZone/MenuBundle/Entity/Menu.php
...
/**
 * @ORM\Table(name="menu")
 * @ORM\Entity(repositoryClass="PiZone\MenuBundle\Entity\Repository\MenuRepository")
...
class Menu {
    ...
    */
     ...
     * Add items
     *
     * @param \PiZone\MenuBundle\Entity\MenuItem $items
     * @return Menu
     */
    public function addItem(\PiZone\MenuBundle\Entity\MenuItem $items)
    {
        $this->items[] = $items;
     ...
     * @param \PiZone\MenuBundle\Entity\MenuItem $items
     */
    public function removeItem(\PiZone\MenuBundle\Entity\MenuItem $items)
    {
