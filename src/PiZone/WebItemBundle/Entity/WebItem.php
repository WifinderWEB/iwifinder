<?php
//src/PiZone/WebItemBundle/Entity/WebItem.php

namespace PiZone\WebItemBundle\Entity;
 ...
 * @ORM\Entity(repositoryClass="PiZone\WebItemBundle\Entity\Repository\WebItemRepository")
 * @UniqueEntity(fields="alias", message="Sorry, this alias is already in use.", groups={"WebItem"})
 */
class WebItem extends Entity{
